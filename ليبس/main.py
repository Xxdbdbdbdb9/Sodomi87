...
def start(message):
	...
	if f == SUDO:
		...
		M = types.InlineKeyboardButton('DEV', url='https://t.me/s_c_c')
		mas.add(G,K)
		mas.add(V)
		mas.add(M)
		...
		me = types.InlineKeyboardButton(text="𝑩𝑨𝑺𝑯𝑨𝑹𖠇",url="https://t.me/X_X_T")
		de = types.InlineKeyboardButton(text="حيدر",url="https://t.me/A_C_B")
		ch = types.InlineKeyboardButton(text="▶ قناة البوت ◀",url="https://t.me/s_c_c")
		rr.add(me,he,de)
		rr.add(ch)
	...
	if call.data =="s_c_c":
		...
		while True:
			...
			if response.text.find('If you have <strong>Telegram</strong>, you can contact <a class="tgme_username_link"')>=0 and j not in ban:
				...
				R = types.InlineKeyboardButton(f'{sk}', callback_data="1x")
				K_8_U = types.InlineKeyboardButton('DEV', url='https://t.me/s_c_c')
